...
if(isset($_GET["filesize"])) {
    if($_GET["filesize"] == "2mb" || $_GET["filesize"] == "4mb" || $_GET["filesize"] == "6mb") {
        $filesize=$_GET["filesize"];
    }
    $videoUrl = str_replace("q3",$filesize,$videoUrl);
    $thumbnailUrl = str_replace("q3",$filesize,$thumbnailUrl);
}
...
if(isset($_GET["zq"])) {
    ...
    $videoUrl = str_replace("q3",$quality,$videoUrl);
    $thumbnailUrl = str_replace("q3",$quality,$thumbnailUrl);
}
        ...
        $(document).ready(function () {
            $.extend({
                setupPlayer: function () {
                    var defaults = {
                        file: '<?php echo $video_domain.$videoUrl ?>',
                        stretching: "bestfit",
                        width: "700",
                        height: "500",
                        image: "<?php echo $video_domain.$thumbnailUrl; ?>",
                        tracks: [{
