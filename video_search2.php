    ...
    <div class="view-container">
                    ...
                    <div class="search-result-cell js-search-result-cell ftl-thumb-mosaic js-hover-container" style="margin-right: 20px;">
                        <div class="video-thumb-frame">
                                <video id='video<?php echo $i; ?>'
                                       width='356'
                                       height='240'
                                       poster='<?php echo $video_domain.$value[3]; ?>'
                                       onMouseOver="onVideoMouseOver(<?php echo $i; ?>);"
                                       onmouseout="video<?php echo $i; ?>.pause()"
                                       controls preload="none">
                                    <?php
                                    $playurl = str_replace("q3","q".$quality,$video_domain.$value[2]);
                                    $playurl2 = str_replace("700w",$width,$playurl);
                                    ?>
                                    <source src='<?php echo $playurl2 ?>' type='video/mp4' />
                                </video>
                        </div>
                        <div align="center"><a href="video_detail.php?id=<?php echo $value[0]; ?>&q=<?php echo $quality; ?>&region=<?php echo $region; ?>" class="detail2" ><?php echo $value[1]; ?></a></div>
                    </div>
                    <?php
                    $i++;
                }?>
        ...
        <div class="pagination-wrapper">
            <form action="/search" method="get">
                <input type="hidden" name="k" value="nature" id="k"><input type="hidden" name="filters[content_type:photo]" value="1" id="filters-content_type:photo"><input type="hidden" name="filters[content_type:illustration]" value="1" id="filters-content_type:illustration"><input type="hidden" name="filters[content_type:zip_vector]" value="1" id="filters-content_type:zip_vector"><input type="hidden" name="safe_search" value="1" id="safe_search"><input type="hidden" name="order" value="relevance" id="order"><ul class="pagination-list">
                <li class=""><a href="/search?k=nature&amp;filters%5Bcontent_type%3Aphoto%5D=1&amp;filters%5Bcontent_type%3Aillustration%5D=1&amp;filters%5Bcontent_type%3Azip_vector%5D=1&amp;safe_search=1&amp;colors=&amp;order=relevance&amp;search_page=1">1</a></li>
                <li class=""><a href="/search?k=nature&amp;filters%5Bcontent_type%3Aphoto%5D=1&amp;filters%5Bcontent_type%3Aillustration%5D=1&amp;filters%5Bcontent_type%3Azip_vector%5D=1&amp;safe_search=1&amp;colors=&amp;order=relevance&amp;search_page=2">2</a></li>
                <li class=""><a href="/search?k=nature&amp;filters%5Bcontent_type%3Aphoto%5D=1&amp;filters%5Bcontent_type%3Aillustration%5D=1&amp;filters%5Bcontent_type%3Azip_vector%5D=1&amp;safe_search=1&amp;colors=&amp;order=relevance&amp;search_page=3">3</a></li>
                <li class=" active-pagination"><a href="/search?k=nature&amp;filters%5Bcontent_type%3Aphoto%5D=1&amp;filters%5Bcontent_type%3Aillustration%5D=1&amp;filters%5Bcontent_type%3Azip_vector%5D=1&amp;safe_search=1&amp;colors=&amp;order=relevance&amp;search_page=4">4</a></li>
                <li class=""><a href="/search?k=nature&amp;filters%5Bcontent_type%3Aphoto%5D=1&amp;filters%5Bcontent_type%3Aillustration%5D=1&amp;filters%5Bcontent_type%3Azip_vector%5D=1&amp;safe_search=1&amp;colors=&amp;order=relevance&amp;search_page=5">5</a></li>
                <li class="ellipses">...</li>
                <li class=""><a href="/search?k=nature&amp;filters%5Bcontent_type%3Aphoto%5D=1&amp;filters%5Bcontent_type%3Aillustration%5D=1&amp;filters%5Bcontent_type%3Azip_vector%5D=1&amp;safe_search=1&amp;colors=&amp;order=relevance&amp;search_page=100">100</a></li>
                <li title="Next page"><a href="/search?k=nature&amp;filters%5Bcontent_type%3Aphoto%5D=1&amp;filters%5Bcontent_type%3Aillustration%5D=1&amp;filters%5Bcontent_type%3Azip_vector%5D=1&amp;safe_search=1&amp;colors=&amp;order=relevance&amp;search_page=5" rel="nofollow"><i class="icon-arrow-right"></i></a></li>
